...
func (s *Server) Routes() *http.ServeMux {
	...
	scoped("POST /api/servers/{server}/players/{entityId}/pm", s.handlePrivateMessage)
	scoped("GET /api/servers/{server}/players/{entityId}/inventory", s.handleShowInventory)
	scoped("POST /api/servers/{server}/players/{entityId}/unlock", s.handleUnlockInventories)
	scoped("POST /api/servers/{server}/players/kickall", s.handleKickAll)
	scoped("GET /api/servers/{server}/land-claims", s.handleListLandClaims)
	scoped("POST /api/servers/{server}/land-claims/remove", s.handleRemoveLandClaims)
	scoped("GET /api/servers/{server}/access", s.handleAccess)
	scoped("POST /api/servers/{server}/access/admin", s.handleSetAdmin)
	scoped("POST /api/servers/{server}/access/admin/remove", s.handleRemoveAdmin)
	scoped("POST /api/servers/{server}/access/whitelist", s.handleAddWhitelist)
	...
	scoped("GET /api/servers/{server}/world/weather", s.handleCurrentWeather)
	scoped("GET /api/servers/{server}/vitals", s.handleServerVitals)
	scoped("GET /api/servers/{server}/items/{name}/icon", s.handleItemIcon)
	...
	scoped("POST /api/servers/{server}/world/airdrop", s.handleAirDrop)
	scoped("POST /api/servers/{server}/world/say", s.handleSay)
	scoped("POST /api/servers/{server}/world/scouts", s.handleSpawnScouts)
	scoped("POST /api/servers/{server}/world/save", s.handleSaveWorld)
